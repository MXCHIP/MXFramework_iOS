...
SWIFT_CLASS("_TtC7MeshSDK19MXMeshDeviceMessage")
@interface MXMeshDeviceMessage : NSObject
...
- (void)updateTranscodingMappingWithData:(NSDictionary<NSString *, id> * _Nullable)data;
...
SWIFT_CLASS("_TtC7MeshSDK10MXMeshTool")
@interface MXMeshTool : NSObject
+ (uint8_t)getFeatureFlagWithUuid:(NSString * _Nonnull)uuid SWIFT_WARN_UNUSED_RESULT;
+ (NSString * _Nonnull)getNodeMacAddressWithUuid:(NSString * _Nonnull)uuid SWIFT_WARN_UNUSED_RESULT;
...
@property (nonatomic, copy) NSDictionary<NSString *, id> * _Nonnull meshMessageDict;
